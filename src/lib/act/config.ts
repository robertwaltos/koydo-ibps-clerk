// Auto-generated shim — re-exports from @/lib/ibps-clerk/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _ibps_clerk_Config } from "@/lib/ibps-clerk/config";
import { EXAM_CONFIG as _raw } from "@/lib/ibps-clerk/config";

// Normalise to the common shape expected by ecosystem components
export const EXAM_CONFIG = {
  ..._raw,
  examId: (_raw as {"examId"?: string; "slug"?: string}).examId ?? (_raw as {"slug"?: string}).slug ?? "ibps-clerk",
