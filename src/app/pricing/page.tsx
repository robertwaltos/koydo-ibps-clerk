...
export const metadata: Metadata = {
  title: "Pricing — Ibps Clerk Premium",
  description: "Unlock unlimited Ibps Clerk practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ibps-clerk&cadence=annual`;
